...
class LinearProgram {
 public:
  ...
  ColIndex CreateNewSlackVariable(
      bool is_integer_slack_variable,
  ...
  bool SolutionIsWithinVariableBounds(
      const DenseRow& solution,
