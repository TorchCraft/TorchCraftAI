...
class LPSolver {
 public:
  ...
  ProblemStatus SolveWithTimeLimit(
 ...
 private:
  ...
  void RunRevisedSimplexIfNeeded(
  ...
  // performed.
  bool IsProblemSolutionConsistent(
      const LinearProgram& lp,
  ...
  double ComputePrimalValueInfeasibility(
      const LinearProgram& lp,
      bool* is_too_large);
  double ComputeActivityInfeasibility(
      const LinearProgram& lp,
      bool* is_too_large);
  double ComputeDualValueInfeasibility(
      const LinearProgram& lp,
      bool* is_too_large);
  double ComputeReducedCostInfeasibility(
      const LinearProgram& lp,
      bool* is_too_large);
