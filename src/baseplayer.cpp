...
BasePlayer::BasePlayer(
  ...
  state_ = new State(client_, stateConfig);
...
void BasePlayer::step() {
  ...
  common::setLoggingFrame(client_->state()->frame_from_bwapi);
...
void BasePlayer::dumpTraceAlongReplay(
  ...
  if (!perspective.empty()) {
    findModule<CherryVisDumperModule>()->setMultiDump(perspective);
  }
