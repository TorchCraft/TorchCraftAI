...
int constexpr UnitStatVFeaturizer::kNumChannels;
...
void UnitStatVFeaturizer::extractUnit(TensorDest acc, cherrypi::Unit* u) {
  UnitStatFeaturizer::extractUnit(acc, u);
  acc[kNumChannels - 1] = u->visible;
}
