...
/// Adds a single bit for Unit::visible to UnitStatFeaturizer
struct UnitStatVFeaturizer : UnitStatFeaturizer {
  static constexpr int kNumChannels = UnitStatFeaturizer::kNumChannels + 1;

  UnitStatVFeaturizer() {
    type = CustomFeatureType::UnitStatV;
    name = "UnitStatV";
    numChannels = kNumChannels;
  }
